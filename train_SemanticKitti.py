...
#                  max_epoch迭代次数由当前文件的parameters.txt文件所决定           
#                  parameters.txt生成方式 1.无先前训练路径，根据train_Semantickitti文件中max_epoch变量决定
#                                       2.有训练路径，根据此次原先的训练路径完全生成一样的路径
#               
#
#
#
...
if __name__ == '__main__':
    ...
    #previous_training_path = 'Log_2022-11-08_12-10-30'  第一轮 4934帧 semantickitti数据集
    #previous_training_path = 'Log_2022-11-09_03-30-29'     第一轮 4934帧 semantickitti数据集
    #previous_training_path = 'Log_2022-11-09_10-34-13'  
