...
class ModelTester:
    ...
    #def slam_segmentation_test(self, net, test_loader, config, num_votes=100, debug=True):
        ...
        while True:
                ...
                for b_i, length in enumerate(lengths):
                   ...
                   # du qu yuan shi .npy wen jian
                    ...
                    if test_loader.dataset.set == 'validation':
                        ...
                        # jian'ge20 sheng cheng yi ge fang zheng shu ju
                        if f_ind % 20 == 0:
            ...
            #已修改进行调整
            # yuan:if last_min + 1 < new_min:  
            #xian if last_min + 0.5 < new_min:
